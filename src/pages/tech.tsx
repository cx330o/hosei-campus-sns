...
const techCategories: {
...
}[] = [
  {
    ...
    items: [
      ...
      { name: "Radix UI", version: "‚Ä?, description: "Accessible Primitives", color: "from-purple-600 to-violet-400" },
    ],
  },
  {
    key: "tech.animation",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "PWA", version: "‚Ä?, description: "Installable App", color: "from-pink-500 to-rose-400" },
...
const features = [
  { emoji: "üöÜ", text: "Real-time train timetable with 3 stations" },
  { emoji: "üöÜ", text: "Train schedule integration (Ekitan data)" },
  { emoji: "‚è±Ô∏è", text: "Live countdown to next train" },
  { emoji: "üè´", text: "Estimated arrival at 4 campus buildings" },
  { emoji: "üåô", text: "Dark mode with system preference detection" },
  { emoji: "üåê", text: "i18n: Japanese / Chinese / English" },
  { emoji: "üì±", text: "PWA: installable, offline-capable" },
  { emoji: "üíÄ", text: "Skeleton loading states" },
  { emoji: "‚ú?, text: "Particle background & GSAP animations" },
  { emoji: "üîí", text: "Zod runtime schema validation" },
];
        ...
        <footer className="pt-8 border-t border-white/10 text-center text-sm text-white/40">
          <div className="flex items-center justify-center gap-3 mb-3">
            <img
              ...
              alt="Ê≥ïÊîøÂ§ßÂ≠¶ ÊÉÖÂ†±ÁßëÂ≠¶Á†îÁ©∂Áß?
              width={40}
              height={40}
              className="rounded-md opacity-70"
            />
            <span>Ê≥ïÊîøÂ§ßÂ≠¶ ÊÉÖÂ†±ÁßëÂ≠¶Á†îÁ©∂Áß?/span>
          </div>
          <p>¬©CODE MATESÔ∏?/p>
        </footer>
      </div>
